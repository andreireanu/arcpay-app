...
interface CounterOffersListProps {
  ...
  // seller knows what they're accepting. Omitted on a single offer's page, where
  // the name is implicit. This is display-only: the on-chain accept never links
  // the counter offers to a listing, so the anonymity is unaffected.
